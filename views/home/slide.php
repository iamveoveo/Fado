    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="assets/img/Fado.VN_1638781690.975.jpg" class="d-block w-130 float-img " alt="...">
          </div>
          
          <div class="carousel-item">
            <img src="assets/img/Fado.VN_1638751033.8798.jpg" class="d-block w-130 float-img " alt="..." >
          </div>
          
          <div class="carousel-item">
            <img src="assets/img/Fado.VN_1638781465.8253.jpg" class="d-block w-130 float-img " alt="..." >
          </div>
         
          <div class="carousel-item">
            <img src="assets/img/Fado.VN_1638788279.1777.jpg" class="d-block w-130 float-img " alt="..." >
          </div>
          <div class="carousel-item">
            <img src="assets/img/Fado.VN_1638780790.6917.jpg" class="d-block w-130 float-img " alt="..." >
          </div>
          <div class="carousel-item">
            <img src="assets/img/Fado.VN_1638596323.9046.jpg" class="d-block w-130 float-img " alt="...">
          </div>
        </div>
                    ...
                    <div class="feature-list">
                        <div class="feature-item">
                            <div class="feature-item-inner">
                                ...
                                <div class="feature-item-content">Giá bạn thấy bằng giá bạn trả</div>
                            </div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-item-inner">
                                ...
                                <div class="feature-item-content">Yên tâm mua sắm, giải tỏa rủi ro</div>
                            </div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-item-inner">
                                ...
                                <div class="feature-item-content">Hàng chất lượng rõ nguồn gốc</div>
                            </div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-item-inner">
                                ...
                                <div class="feature-item-content">Sản phẩm nhập khẩu chính ngạch</div>
                            </div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-item-inner">
                                ...
                                <div class="feature-item-content">Liên tục cập nhật hành trình</div>
                            </div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-item-inner">
                                ...
                                <div class="feature-item-content">Miễn phí giao hàng trong nước</div>
                            </div>
                        </div>
                    </div>
                </div>
